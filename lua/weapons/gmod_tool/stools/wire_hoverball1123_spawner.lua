...
TOOL.Name = "Wired Marums HoverBall"
TOOL.Command = nil
...
function TOOL:RightClick( trace )
    if(trace.Hit) then
        if(trace.Entity and IsValid(trace.Entity) and !trace.Entity:IsPlayer()) then
            ...
            self:GetOwner():ConCommand("wire_hoverball1123_spawner_model " .. trace.Entity:GetModel())
        end
    end
end
...
function TOOL.BuildCPanel( panel )
    ...
    panel:AddControl( "PropSelect", { Label = "Model", ConVar = "wire_hoverball1123_spawner_model", Models = list.Get( "MarumsHoverballModels" ), Height = 5 } )
    ...
    panel:AddControl("Slider", {
        ...
        Min = "0",
        Max = "2500",
        Command = "wire_hoverball1123_spawner_force"
    })
    ...
    panel:AddControl("Slider", {
        ...
        Min = "0",
        Max = "37650",
        Command = "wire_hoverball1123_spawner_height"
    })
    ...
    panel:AddControl("Slider", {
        ...
        Min = "0",
        Max = "30",
        Command = "wire_hoverball1123_spawner_air_resistance"
    })
    ...
    panel:AddControl("Slider", {
        ...
        Min = "0",
        Max = "120",
        Command = "wire_hoverball1123_spawner_angular_damping"
    })

    panel:AddControl("checkbox", {
        Label = "Hovers over water",
        Command = "wire_hoverball1123_spawner_detects_water"
    })
end
...
if CLIENT then
    ...
    language.Add( "tool.wire_hoverball1123_spawner.name", "Marum's Hoverball" )
    language.Add( "tool.wire_hoverball1123_spawner.desc", "These hoverballs go up and down ramps and hills, like hovercrafts." )
    language.Add( "tool.wire_hoverball1123_spawner.0", "Left-click: Spawn a hoverball. Spawn on an entity to weld it." )
    language.Add( "undone.wire_hoverball1123_spawner", "Undone Marum's hoverball" )
end
